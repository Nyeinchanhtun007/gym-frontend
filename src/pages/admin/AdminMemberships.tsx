...
import { CreditCard, Edit3, Clock } from "lucide-react";
...
export default function AdminMemberships() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-card/50 backdrop-blur-2xl border border-border rounded-[2rem] relative z-50">
                  ...
                  >
                    ...
                    <td className="px-8 py-6 text-right">
                      <button
                        ...
                        className="w-10 h-10 rounded-xl bg-foreground/5 flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all ml-auto border border-border"
                      >
