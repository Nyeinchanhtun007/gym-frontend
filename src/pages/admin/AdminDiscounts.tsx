      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {statsCards.map((s) => (
          <motion.div
            ...
            className={`bg-card/50 backdrop-blur-2xl border rounded-[1.5rem] p-5 flex items-center gap-4 ${s.bg}`}
          >
            <div
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center justify-between p-4 bg-foreground/5 rounded-xl border border-border">
                    <div>
                      ...
                      <div className="text-[9px] font-bold text-foreground/30 mt-0.5 uppercase">
